...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_llm_prompts,
            commands::get_llm_prompt,
            commands::create_llm_prompt,
            commands::update_llm_prompt,
            commands::delete_llm_prompt,
            ...
            commands::get_codex_leaderboard,
            commands::get_codex_skill_usage_details,
